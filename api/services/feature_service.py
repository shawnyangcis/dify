...
class FeatureService:
    ...
    def _fulfill_system_params_from_env(cls, system_features: SystemFeatureModel):
        ...
        system_features.enable_custom_sso = (
            dify_config.SSO_ENABLED 
            and bool(dify_config.SSO_CLIENT_ID)
            and bool(dify_config.SSO_CLIENT_SECRET)
            and bool(dify_config.SSO_AUTH_ENDPOINT)
            and bool(dify_config.SSO_TOKEN_ENDPOINT)
            and bool(dify_config.SSO_USERINFO_ENDPOINT)
            and bool(dify_config.SSO_REDIRECT_URI)
        )
